...
# ADD LINK32 kernel32.lib xpawk.lib /nologo /subsystem:console /machine:I386 /libpath:"..\..\bas" /libpath:"..\..\awk\release"
...
# ADD LINK32 kernel32.lib xpawk.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"..\..\bas" /libpath:"..\..\awk\debug"
