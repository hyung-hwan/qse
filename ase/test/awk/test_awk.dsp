...
# ADD LINK32 aseawk.lib xpbas.lib user32.lib kernel32.lib /nologo /subsystem:console /machine:I386 /out:"../../release/win32/vs60/awk.exe" /libpath:"$(OutDir)" /libpath:"\projects\xpkit\release"
...
# ADD LINK32 aseawk.lib xpbas.lib user32.lib kernel32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../debug/win32/vs60/awk.exe" /pdbtype:sept /libpath:"$(OutDir)" /libpath:"\projects\xpkit\debug"
