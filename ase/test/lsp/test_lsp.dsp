...
# ADD LINK32 aselsp.lib  xpbas.lib user32.lib kernel32.lib /nologo /subsystem:console /machine:I386 /out:"..\..\..\release\lsp.exe" /libpath:"..\..\release" /libpath:"\projects\xpkit\release"
...
# ADD LINK32 aselsp.lib xpbas.lib user32.lib kernel32.lib /nologo /subsystem:console /debug /machine:I386 /out:"..\..\..\debug\lsp.exe" /pdbtype:sept /libpath:"..\..\debug" /libpath:"\projects\xpkit\debug"
