...
# ADD LINK32 aselsp.lib  asecmn.lib aseutl.lib user32.lib kernel32.lib /nologo /subsystem:console /machine:I386 /out:"../../release/aselsp.exe" /libpath:"$(OutDir)"
...
# ADD LINK32 aselsp.lib asecmn.lib aseutl.lib user32.lib kernel32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../debug/aselsp.exe" /pdbtype:sept /libpath:"$(OutDir)"
